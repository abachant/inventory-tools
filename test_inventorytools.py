...
class TestCombineDuplicateEntries(unittest.TestCase):
    ...
    def test_combine_duplicate_entries(self):
        ...
        pd.testing.assert_frame_equal(output_df, self.combined_df, obj="Output DataFrame does not match the expected combined DataFrame.")
